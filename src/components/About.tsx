      ...
      <div className="about-container">
        <div className="about-grid">
          <div className="about-img-wrap reveal">
            <Image src="https://vivekshah.netlify.app/images/vs.png" alt="Vivek Shah" width={420} height={520} style={{ width: '100%', height: 'auto' }} />
          ...
          <div className="about-text">
            ...
            <div className="reveal reveal-delay-4" style={{ marginTop: 28, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <a href="https://vivekshah.netlify.app/images/Vivek_Shah_Sr_Product_Designer_CV.pdf" target="_blank" rel="noreferrer" className="btn-primary-custom">

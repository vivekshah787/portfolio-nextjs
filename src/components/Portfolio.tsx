...
const PROJECTS = [
  { num: '01', name: 'DocDoc', tagline: 'Healthcare booking platform — end-to-end patient journey redesign', tags: ['SaaS', 'Healthcare', 'UI/UX'], year: '2023', cat: 'web saas', url: 'https://www.docdoc.com/', img: 'https://vmshah.netlify.app/images/portfolio-img1.png' },
  { num: '02', name: 'Spring Money', tagline: 'Fintech platform — investment dashboards & onboarding flows', tags: ['SaaS', 'Fintech', 'Dashboard'], year: '2023', cat: 'web saas', url: 'https://spring.money/', img: 'https://vmshah.netlify.app/images/portfolio-img2.png' },
  { num: '03', name: 'AdRoll', tagline: 'Marketing attribution platform — complex analytics made intuitive', tags: ['Web', 'Analytics', 'Marketing'], year: '2022', cat: 'web saas', url: 'https://www.adroll.com/home-b', img: 'https://vmshah.netlify.app/images/portfolio-img5.png' },
  { num: '04', name: 'Reece Safety', tagline: 'B2B e-commerce — product catalogue & procurement UX', tags: ['E-Commerce', 'B2B'], year: '2022', cat: 'web ecommerce', url: 'https://www.reecesafety.com/', img: 'https://vmshah.netlify.app/images/portfolio-img3.png' },
  { num: '05', name: 'Popdust', tagline: 'Entertainment media — high-velocity editorial UI system', tags: ['Editorial', 'Branding'], year: '2021', cat: 'web branding', url: 'https://www.popdust.com/', img: 'https://vmshah.netlify.app/images/portfolio-img6.png' },
  { num: '06', name: 'Trueself', tagline: 'Wellness & personal development — calm, trust-first visual identity', tags: ['Wellness', 'Branding'], year: '2021', cat: 'web branding', url: 'https://www.trueself.com/', img: 'https://vmshah.netlify.app/images/portfolio-img7.png' },
  { num: '07', name: 'Reggiocase', tagline: 'Italian real estate portal — property search & agent experience', tags: ['Real Estate', 'Web'], year: '2020', cat: 'web', url: 'https://www.reggiocase.it/', img: 'https://vmshah.netlify.app/images/portfolio-img4.png' },
];
